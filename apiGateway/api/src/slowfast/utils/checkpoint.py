...
import api.src.slowfast.utils.distributed as du
import api.src.slowfast.utils.logging as logging
from api.src.slowfast.utils.c2_model_loading import get_name_convert_func
...
def load_test_checkpoint(cfg, model):
    ...
    cfg.TEST.CHECKPOINT_FILE_PATH = cfg.UNIFORMER.PRETRAIN_NAME
